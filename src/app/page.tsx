      ...
      <section className="py-24 bg-background">
        <div className="container px-4 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            <Link href="/products?category=nike" className="group block relative h-[450px] lg:h-[500px] overflow-hidden rounded-[2rem] shadow-lg">
              <Image 
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-end items-start text-left z-10">
                ...
                <h3 className="text-white text-4xl lg:text-5xl font-black uppercase tracking-widest translate-y-2 group-hover:translate-y-0 transition-all duration-500">
                  Nike
                </h3>
              </div>
            </Link>
            <Link href="/products?category=jordan" className="group block relative h-[450px] lg:h-[500px] overflow-hidden rounded-[2rem] shadow-lg">
              <Image 
            ...
            <Link href="/products?category=adidas" className="group block relative h-[450px] lg:h-[500px] overflow-hidden rounded-[2rem] shadow-lg">
              <Image 
