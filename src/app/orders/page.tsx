        ...
        <aside className="w-full md:w-64 shrink-0">
          <div className="bg-secondary/30 rounded-3xl p-6 sticky top-24">
            ...
            <nav className="flex md:flex-col gap-2 overflow-x-auto">
              <Link href="/profile" className="flex items-center justify-between p-3 rounded-xl hover:bg-secondary/50 transition-colors text-muted-foreground hover:text-foreground">
                <span className="flex items-center gap-2"><User className="h-4 w-4" /> Profilim</span>
              </Link>
              <Link href="/orders" className="flex items-center justify-between p-3 rounded-xl bg-background border font-medium">
        ...
        <div className="flex-1 space-y-8">
          <section className="bg-secondary/20 border rounded-3xl p-6 md:p-8">
            <h2 className="text-xl font-bold mb-6 flex items-center gap-2">
              <Package className="h-5 w-5" /> Tüm Siparişlerim
            </h2>
