...
export function Footer() {
  ...
  return (
    <footer className="mt-auto border-t bg-background py-12">
      <div className="container mx-auto grid grid-cols-1 gap-8 px-4 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>
              <Link href="/products?category=nike" className="transition-colors hover:text-primary">
                Nike
              </Link>
            </li>
            <li>
              <Link href="/products?category=adidas" className="transition-colors hover:text-primary">
                Adidas
              </Link>
            </li>
            <li>
              <Link href="/products?category=jordan" className="transition-colors hover:text-primary">
                Jordan
              </Link>
            </li>
          </ul>
      ...
      <div className="container mx-auto mt-12 border-t px-4 pt-8 text-center text-sm text-muted-foreground">
